#ifndef _SHIFTCTRLDELETEKEYACTIONCOMMAND_H
#define _SHIFTCTRLDELETEKEYACTIONCOMMAND_H
...
class ShiftCtrlDeleteKeyActionCommand :public Command
{
public:
	ShiftCtrlDeleteKeyActionCommand(NotepadForm* notepadForm = 0);//디폴트생성자
	...
	virtual ~ShiftCtrlDeleteKeyActionCommand();//소멸자
...
//인라인함수 정의
inline Glyph* ShiftCtrlDeleteKeyActionCommand::GetGlyph() const
{
	return this->glyph;
}

#endif // !_SHIFTCTRLDELETEKEYACTIONCOMMAND_H
