...
public:
	...
	//디폴트생성자에서 notepadForm을 받아서 캐럿이랑 노트패드랑 관계맺어주기
	...
	//캐럿 생성하기 높이,너비를 입력받아 캐럿을 생성하기 createsolidCaret
	void Create(Long height, Long width);
	void Move(Long x, Long y);//캐럿 이동하기 SetCaretPos
	void Show();//캐럿 보여주기 ShowCaret
	//인라인함수
	//CDC& GetDc() const; CDC랑 캐럿이랑 관계를 맺는게 아니라 notepadForm이랑 캐럿이랑 관계맺기
