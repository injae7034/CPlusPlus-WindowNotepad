...
//디폴트생성자
SelectingTexts::SelectingTexts(NotepadForm* notepadForm)
{
	this->notepadForm = notepadForm;
}

//다음으로 선택하다
void SelectingTexts::DoNext(Long previousRowIndex, Long previousLetterIndex,
...
//이전으로 선택하다
void SelectingTexts::DoPrevious(Long previousRowIndex, Long previousLetterIndex,
	Long currentRowIndex, Long currentLetterIndex)
{
	Glyph* row = 0;
	Glyph* letter = 0;
